...
namespace SONHA.Controllers.Admin.News
{
    public class NewsadController : Controller
    {
        ...
        public ActionResult Create(tblNew tblnews, FormCollection Collection, string id, int[] MutilMenu)
        {
            ...
            if (nidCate != "")
            {
                ...
                clsSitemap.CreateSitemap("3/" + tblnews.Tag+"-"+tblnews.id+".aspx", listprro[0].id.ToString(), "News");
            ...
            if (ModelState.IsValid)
            {
                if (collection["drMenu"] != "" || collection["drMenu"] != null)
                {
                    ...
                    else
                    {
                     ...
                     clsSitemap.CreateSitemap("3/" + tblnews.Tag + "-" + tblnews.id + ".aspx", id.ToString(), "Newsad");
                    ...
                    {
                        tblnews.Tag = StringClass.NameToTag(tblnews.Name);
                        clsSitemap.UpdateSitemap("3/" + StringClass.NameToTag(tblnews.Name)+"-"+tblnews.id+".aspx", id.ToString(), "News");
