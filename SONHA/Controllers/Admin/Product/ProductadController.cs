    ...
    public class ProductadController : Controller
    {
        ...
        public ActionResult Create(tblProduct tblproduct, FormCollection Collection, string id, List<HttpPostedFileBase> uploadFile)
        {
            ...
            if (nidCate != "")
            {
                ...
                clsSitemap.CreateSitemap("0/" + tblproduct.Tag+ "-"+tblproduct.idCate+"-"+tblproduct.id+".aspx", listprro[0].id.ToString(), "Product");
            ...
            if (ModelState.IsValid)
            {
                if (collection["drMenu"] != "" || collection["drMenu"] != null)
                {
                    ...
                    if (URL == true)
                    {
                        ...
                        clsSitemap.UpdateSitemap("0/" + tblproduct.Tag + "-" + tblproduct.idCate + "-" + tblproduct.id + ".aspx", id.ToString(), "Product");
