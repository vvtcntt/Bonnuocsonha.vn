...
using SONHA.Models;
namespace SONHA.Controllers.Display.Header
{
    ...
    public class HeaderController : Controller
    {
        ...
        public PartialViewResult MenuPartial()
        {
            ...
            {
                chuoi += "<li class=\"li1\">";
                chuoi += " <a href=\"/1/" + item.Tag + "-"+item.id+".aspx\" title=\"" + item.Name + "\">" + item.Name + "</a>";
                int idcate = item.id;
                ...
                if (Listchild.Count > 0)
                {
                    ...
                    {
                        chuoi += "<li class=\"li2\"><a href=\"/1/" + item1.Tag + "-" + item.id + ".aspx\" title=\"" + item1.Name + "\">" + item1.Name + "</a>";
                        chuoi += "</li> ";
                    }
                    chuoi += " </ul>";
                }
