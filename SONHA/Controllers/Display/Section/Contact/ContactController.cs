...
namespace SONHA.Controllers.Display.Section.Contact
{
    public class ContactController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Description = "<meta name=\"description\" content=\"Liên hệ của khách hàng khi mua sản phẩm bồn nước tại siêu thị bồn nước SONHA\"/>";
