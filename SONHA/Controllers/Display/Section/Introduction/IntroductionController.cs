...
namespace SONHA.Controllers.Display.Section.Introduction
{
    public class IntroductionController : Controller
    {
        ...
        {
            var tblnews = db.tblNews.FirstOrDefault(p => p.idCate==3);
            ...
            string meta = "";
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://bonnuocsonha.vn/Gioi-thieu\" />";
