...
using SONHA.Models;
namespace SONHA.Controllers.Display.Section
{
    public class RightController : Controller
    {
        ...
        public PartialViewResult PartialMenuProductAll()
        {
            ...
            {
                chuoi += "<li class=\"li_1\">";
                chuoi += "<a href=\"/1/" + item.Tag + "-"+item.id+".aspx\" title=\"" + item.Name + "\"><i></i>" + item.Name + "</a>";
                int idcate = item.id;
                ...
                if (ListChild.Count > 0)
                {
                    ...
                    {
                        chuoi += "<li class=\"li_2\"><a href=\"/1/" + item1.Tag + "-" + item.id + ".aspx\" title=\"" + item1.Name + "\">› " + item1.Name + "</a></li>";
                    }
                    chuoi += "</ul>";
                }
        ...
        public PartialViewResult partialNewsHomes()
        {
            ...
            foreach(var item in listnews)
            {
                ...
                chuoi += "<h4><a href=\"/3/" + item.Tag + "-"+item.id+".aspx\" title=\"" + item.Name + "\">" + item.Name + "</a></h4>";
