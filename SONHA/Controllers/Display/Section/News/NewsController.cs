...
namespace SONHA.Controllers.Display.Section.News
{
    public class NewsController : Controller
    {
        ...
        public ActionResult NewsDetail(string tag)
        {
            ...
            string meta = "";
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://bonnuocsonha.vn/3/" + StringClass.NameToTag(tblnews.Tag) + "-"+tblnews.id+".aspx\" />";

            meta += "<meta itemprop=\"name\" content=\"" + tblnews.Name + "\" />";
            meta += "<meta itemprop=\"url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta itemprop=\"description\" content=\"" +tblnews.Description + "\" />";
            meta += "<meta itemprop=\"image\" content=\"http://bonnuocsonha.vn" + tblnews.Images + "\" />";
            meta += "<meta property=\"og:title\" content=\"" + tblnews.Title + "\" />";
            meta += "<meta property=\"og:type\" content=\"product\" />";
            meta += "<meta property=\"og:url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta property=\"og:image\" content=\"http://bonnuocsonha.vn" + tblnews.Images + "\" />";
            ...
            if (tblnews.Keyword != null)
            {
                ...
                if (Lienquan.Count > 0)
                {
                    ...
                    {
                        chuoinew += "<a href=\"/3/" + Lienquan[i].Tag + "-"+Lienquan[i].id+".aspx\" title=\"" + Lienquan[i].Name + "\"> " + Lienquan[i].Name + "</a>";
                    }
                    chuoinew += "</div>";
                }
