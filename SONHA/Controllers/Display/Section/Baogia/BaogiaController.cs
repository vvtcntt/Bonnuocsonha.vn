...
namespace Bonnuoc.Controllers.Display.Section.Baogia
{
    public class BaogiaController : Controller
    {
        ...
        public ActionResult BaogiaDetail(string tag)
        {
            ...
            ViewBag.Description = "<meta name=\"description\" content=\"Bảng báo giá mới nhất dành cho sản phẩm " + tblgroupproduct.Name + " của siêu thị bồn nước SONHA dành cho quý khách hàng\"/>";
            ...
            for (int i = 0; i < listProduct.Count; i++)
            {
                ...
                chuoi += "<td class=\"Names\"><a href=\"/0/" + listProduct[i].Tag + "-"+listProduct[i].idCate+"-"+listProduct[i].id+".aspx\" title=\"" + listProduct[i].Name + "\">" + listProduct[i].Name + "</a> </td>";
                ...
                chuoi += " <td class=\"Images\"><a href=\"/0/" + listProduct[i].Tag + "-" + listProduct[i].idCate + "-" + listProduct[i].id + ".aspx\" title=\"" + listProduct[i].Name + "\"><img src=\"" + listProduct[i].ImageLinkThumb + "\" alt=\"" + listProduct[i].Name + "\" title=\"" + listProduct[i].Name + "\"></a></td>";
                chuoi += "</tr>";
            }
            ViewBag.chuoi = chuoi;
