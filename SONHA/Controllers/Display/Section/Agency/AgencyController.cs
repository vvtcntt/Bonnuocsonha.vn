...
using PagedList;
using PagedList.Mvc;
namespace SONHA.Controllers.Display.Section.Agency
{
    public class AgencyController : Controller
    {
        ...
        public ActionResult TagAgency(string tag, int? page)
        {
            ...
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://bonnuocsonha.vn/TagAgency/" + StringClass.NameToTag(chuoitag) + "\" />"; ;
            return View(listnews.ToPagedList(pageNumber, pageSize));
        }
        public ActionResult AngencyDetail(string tag)
        {
            ...
            string meta = "";
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://bonnuocsonha.vn/4/" + StringClass.NameToTag(tag) + "-"+tblagency.id+".aspx\" />";

            meta += "<meta itemprop=\"name\" content=\"" + tblagency.Name + "\" />";
            meta += "<meta itemprop=\"url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta itemprop=\"description\" content=\"" + tblagency.Description + "\" />";
            meta += "<meta itemprop=\"image\" content=\"http://bonnuocsonha.vn" + tblagency.Images + "\" />";
            meta += "<meta property=\"og:title\" content=\"" + tblagency.Name + "\" />";
            meta += "<meta property=\"og:type\" content=\"product\" />";
            meta += "<meta property=\"og:url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta property=\"og:image\" content=\"http://bonnuocsonha.vn" + tblagency.Images + "\" />";
            ...
            if (tblagency.Tabs != null)
            {
                ...
                if (Lienquan.Count > 0)
                {
                    ...
                    {
                        chuoinew += "<a href=\"/4/" + Lienquan[i].Tag + "-"+Lienquan[i].id+".aspx\" title=\"" + Lienquan[i].Name + "\"> " + Lienquan[i].Name + "</a>";
                    }
                    chuoinew += "</div>";
                }
            ...
            {
                chuoinewnew += "<li><a href=\"/4/" + NewsNew[i].Tag + "-"+NewsNew[i].id+".aspx\" title=\"" + NewsNew[i].Name + "\" rel=\"nofollow\"> " + NewsNew[i].Name + " <span>" + NewsNew[i].DateCreate + "</span></a></li>";
            }
