    ...
    public class OrderController : Controller
    {
        ...
        public ActionResult OrderIndex()
        {
            ...
            { 
                for (int i = 0; i < giohang.CartItem.Count; i++)
                {
                    ...
                    chuoi += "<td class=\"Name\" >";
                    chuoi += "<a href=\"/0" + giohang.CartItem[i].Tag + "-" + giohang.CartItem[i].idMenu + "-" + giohang.CartItem[i].id + ".aspx\" title=\"" + giohang.CartItem[i].Name + "\" id=\"UpdateOrd" + giohang.CartItem[i].id + "\"><img src=\"" + giohang.CartItem[i].Images + "\" alt=\"" + giohang.CartItem[i].Name + "\" title=\"" + giohang.CartItem[i].Name + "\" /></a>";
                    chuoi += "<a href=\"/0/" + giohang.CartItem[i].Tag +"-" + giohang.CartItem[i].idMenu + "-" + giohang.CartItem[i].id + ".aspx\" title=\"" + giohang.CartItem[i].Name + "\" class=\"Namepd\">" + giohang.CartItem[i].Name + "</a>";
        ...
        public ActionResult Create(string idp, string ord)
        {
            ...
            for (int i = 0; i < giohang.CartItem.Count; i++)
            {
                ...
                chuoi += "</tr>";
                chuoi1+="<div class=\"Tear_OrderToolbar\">";
                chuoi1 += "<a href=\"/0/" + giohang.CartItem[i].Tag + "-" + giohang.CartItem[i].idMenu + "-"+giohang.CartItem[i].id+".aspx \" title=\"" + giohang.CartItem[i].Name + "\" >";
                chuoi1 += "<img src=\"" + giohang.CartItem[i].Images + "-" + giohang.CartItem[i].idMenu + "-" + giohang.CartItem[i].id + ".aspx\" alt=\"" + giohang.CartItem[i].Name + "\">";
                     chuoi1+="</a>";
                     chuoi1 += " <a href=\"/San-pham/" + giohang.CartItem[i].Tag + "\" title=\"" + giohang.CartItem[i].Name + "\" class=\"Name\"  > " + giohang.CartItem[i].Name + "</a><span>" + string.Format("{0:#,#}", giohang.CartItem[i].Price) + "đ</span>";
                     chuoi1 += " <a href=\"\" class=\"Del\" onclick=\"javascript:return DeleteOrder(" + giohang.CartItem[i].id + ")\"></a></div>";
            }
